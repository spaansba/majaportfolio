    ...
    >
      ...
      <div className={astyles.aboutContent}>
        ...
        >
          <h3>Hi, I&apos;m Maja</h3>
          <p>
            I&apos;m the one who always has a camera in hand at events, on travels, or even just
            popping out my phone to capture those unique, everyday moments. For me, photography is
            all about telling stories, collecting memories, and capturing the spontaneous feelings
            that make life so special. Whether it&apos;s documenting someone&apos;s big day at an
            event or creating powerful portraits with an aesthetic edge, I&apos;m passionate about
            every shot I take. My style mixes creativity with a dash of spontaneity, ensuring each
            image feels as unique as the people in it.
          </p>
          <p>
            When I&apos;m not behind the lens, you&apos;ll find me doing sports or exploring new
            countries—though let&apos;s be real, my camera&apos;s never far away! I also love trying
            new foods and then attempting to recreate them myself at home.
          </p>
          <p>
